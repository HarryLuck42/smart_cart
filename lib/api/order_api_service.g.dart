...
class _OrderApiService implements OrderApiService {
  ...
  @override
  Future<OrderResponse> submitOrder(Map<String, dynamic> body) async {
  ...
  @override
  Future<GetOrderResponse> getOrder(String orderId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<GetOrderResponse>(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late GetOrderResponse _value;
    try {
      _value = GetOrderResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
